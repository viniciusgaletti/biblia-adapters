...
var submitRating = async (learningId, rating, previousRatingId) => {
	if (previousRatingId) await supabase.from("learning_ratings").delete().eq("id", previousRatingId);
...
//#endregion
export { submitRating as i, fetchLearningById as n, searchLearnings as r, createLearning as t };

//# sourceMappingURL=learnings-CbN_tra6.js.map